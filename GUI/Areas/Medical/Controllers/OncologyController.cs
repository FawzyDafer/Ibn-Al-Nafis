...
{
    [Authorize(Roles = "Oncology, Manager, Head quarter")]
    public class OncologyController : DoctorController
    {
        #region Vaiables
        readonly string ClinicTitle = "Oncology";
        readonly string controller;
        #endregion

        #region Constructors
        public OncologyController(IClinicRepository clinicRepository,
