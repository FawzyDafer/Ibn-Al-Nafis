...
{
    [Authorize(Roles = "Plastic Surgery and blood vessels, Manager, Head quarter")]
    public class PlasticSurgeryandbloodvesselsController : DoctorController
    {
        #region Vaiables
        readonly string ClinicTitle = "Plastic Surgery and blood vessels";
        readonly string controller;
        #endregion

        #region Constructors
        public PlasticSurgeryandbloodvesselsController(IClinicRepository clinicRepository,
