...
{
    [Authorize(Roles = "Dermatology, Manager, Head quarter")]
    public class DermatologyController : DoctorController
    {
        #region Vaiables
        readonly string ClinicTitle = "Dermatology";
        readonly string controller;
        #endregion

        #region Constructors
        public DermatologyController(IClinicRepository clinicRepository,
