...
{
    [Authorize(Roles = "Neuropsychiatry, Manager, Head quarter")]
    public class NeuropsychiatryController : DoctorController
    {
        #region Vaiables
        readonly string ClinicTitle = "Neuropsychiatry";
        readonly string controller;
        #endregion

        #region Constructors
        public NeuropsychiatryController(IClinicRepository clinicRepository,
