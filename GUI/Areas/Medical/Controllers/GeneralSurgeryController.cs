...
{
    [Authorize(Roles = "General Surgery, Manager, Head quarter")]
    public class GeneralSurgeryController : DoctorController
    {
        #region Vaiables
        readonly string ClinicTitle = "General Surgery";
        readonly string controller;
        #endregion

        #region Constructors
        public GeneralSurgeryController(IClinicRepository clinicRepository,
