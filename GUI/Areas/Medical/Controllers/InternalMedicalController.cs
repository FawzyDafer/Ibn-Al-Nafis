...
{
    [Authorize(Roles = "Internal Medical, Manager, Head quarter")]
    public class InternalMedicalController : DoctorController
    {
        #region Vaiables
        readonly string ClinicTitle = "Internal Medical";
        readonly string controller;
        #endregion

        #region Constructors
        public InternalMedicalController(IClinicRepository clinicRepository,
