...
{
    [Authorize(Roles = "Pulmonology, Manager, Head quarter")]
    public class PulmonologyController : DoctorController
    {
        #region Vaiables
        readonly string ClinicTitle = "Pulmonology";
        readonly string controller;
        #endregion

        #region Constructors
        public PulmonologyController(IClinicRepository clinicRepository,
