...
{
    [Authorize(Roles = "Pulmonology Surgery, Manager, Head quarter")]
    public class PulmonologySurgeryController : DoctorController
    {
        #region Vaiables
        readonly string ClinicTitle = "Pulmonology Surgery";
        readonly string controller;
        #endregion

        #region Constructors
        public PulmonologySurgeryController(IClinicRepository clinicRepository,
