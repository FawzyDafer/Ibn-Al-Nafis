...
{
    [Authorize(Roles = "Neuro Surgery, Manager, Head quarter")]
    public class NeuroSurgeryController : DoctorController
    {
        #region Vaiables
        readonly string ClinicTitle = "Neuro Surgery";
        readonly string controller;
        #endregion

        #region Constructors
        public NeuroSurgeryController(IClinicRepository clinicRepository,
