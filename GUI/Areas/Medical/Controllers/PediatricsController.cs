...
{
    [Authorize(Roles = "Pediatrics, Manager, Head quarter")]
    public class PediatricsController : DoctorController
    {
        #region Vaiables
        readonly string ClinicTitle = "Pediatrics";
        readonly string controller;
        #endregion

        #region Constructors
        public PediatricsController(IClinicRepository clinicRepository,
