...
{
    [Authorize(Roles = "Urology, Manager, Head quarter")]
    public class UrologyController : DoctorController
    {
        #region Vaiables
        readonly string ClinicTitle = "Urology";
        readonly string controller;
        #endregion

        #region Constructors
        public UrologyController(IClinicRepository clinicRepository,
        ...
        [HttpGet]
        public async Task<IActionResult> RecentOrderRays(long? Admission)
        {
            ViewData["clinic"] = ClinicTitle;
            if (ValidateAdmission(Admission))
            {
        ...
        [HttpGet]
        public async Task<IActionResult> GetRayDetatils(string uname, long? Admission)
        {
            ViewData["clinic"] = ClinicTitle;
            if (ValidateAdmission(Admission))
            {
