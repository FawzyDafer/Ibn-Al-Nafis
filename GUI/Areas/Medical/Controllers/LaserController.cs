...
{
    [Authorize(Roles = "Laser, Manager, Head quarter")]
    public class LaserController : DoctorController
    {
        #region Vaiables
        readonly string ClinicTitle = "Laser";
        readonly string controller;
        #endregion

        #region Constructors
        public LaserController(IClinicRepository clinicRepository,
