...
{
    [Authorize(Roles = "Cardiology, Manager, Head quarter")]
    public class CardiologyController : DoctorController
    {
        #region Vaiables
        readonly string ClinicTitle = "Cardiology";
        readonly string controller;
        #endregion

        #region Constructors
        public CardiologyController(IClinicRepository clinicRepository,
