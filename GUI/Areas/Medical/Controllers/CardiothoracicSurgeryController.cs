...
{
    [Authorize(Roles = "Cardiothoracic Surgery, Manager, Head quarter")]
    public class CardiothoracicSurgeryController : DoctorController
    {
        #region Vaiables
        readonly string ClinicTitle = "Cardiothoracic Surgery";
        readonly string controller;
        #endregion

        #region Constructors
        public CardiothoracicSurgeryController(IClinicRepository clinicRepository,
