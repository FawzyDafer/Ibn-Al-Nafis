...
{
    [Authorize(Roles = "ObsandGyn, Manager, Head quarter")]
    public class ObsandGynController : DoctorController
    {
        #region Vaiables
        readonly string ClinicTitle = "ObsandGyn";
        readonly string controller;
        #endregion

        #region Constructors
        public ObsandGynController(IClinicRepository clinicRepository,
