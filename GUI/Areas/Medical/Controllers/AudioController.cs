...
{
    [Authorize(Roles = "Audio, Manager, Head quarter")]
    public class AudioController : DoctorController
    {
        #region Vaiables
        readonly string ClinicTitle = "Audio";
        readonly string controller;
        #endregion

        #region Constructors
        public AudioController(IClinicRepository clinicRepository,
