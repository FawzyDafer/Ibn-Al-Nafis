...
{
    [Authorize(Roles = "Ophthalmology, Manager, Head quarter")]
    public class OphthalmologyController : DoctorController
    {
        #region Vaiables
        readonly string ClinicTitle = "Ophthalmology";
        readonly string controller;
        #endregion

        #region Constructors
        public OphthalmologyController(IClinicRepository clinicRepository,
