...
{
    [Authorize(Roles = "Endemic, Manager, Head quarter")]
    public class EndemicController : DoctorController
    {
        #region Vaiables
        readonly string ClinicTitle = "Endemic";
        readonly string controller;
        #endregion

        #region Constructors
        public EndemicController(IClinicRepository clinicRepository,
