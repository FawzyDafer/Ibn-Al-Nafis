...
{
    [Authorize(Roles = "Otorhinolaryngology, Manager, Head quarter")]
    public class OtorhinolaryngologyController : DoctorController
    {
        #region Vaiables
        readonly string ClinicTitle = "Otorhinolaryngology";
        readonly string controller;
        #endregion

        #region Constructors
        public OtorhinolaryngologyController(IClinicRepository clinicRepository,
